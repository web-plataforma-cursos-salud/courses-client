...
export default function CardLogin({ onClose, onSignUpClick  }) {
  return (
    <div className="relative flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
      {/* Imagen de fondo */}
      <div className="hidden lg:block lg:w-1/2 bg-cover" style={{ backgroundImage: `url(${imageLogin})` }}></div>
      ...
      <div className="w-full px-6 py-8 md:px-8 lg:w-1/2 relative">
        ...
        >
          ...
          <span className="w-5/6 px-4 py-3 font-bold text-center">Ingresar con Google</span>
        </a>

        <div className="flex items-center justify-between mt-4">
          <span className="w-1/5 border-b dark:border-gray-600 lg:w-1/4"></span>
          <a href="#iniciar-sesión" className="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">O inicia sesión con correo</a>
          <span className="w-1/5 border-b dark:border-gray-600 lg:w-1/4"></span>
        </div>
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <a onClick={onSignUpClick} href="#Registrarse" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline ">O regístrate</a>
          <span className="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
        </div>
      </div>
    </div>
