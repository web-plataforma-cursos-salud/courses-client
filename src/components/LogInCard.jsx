...
export default function LogInCard() {
  return (
    <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
      {/* Imagen de fondo */}
      <div className="hidden lg:block lg:w-1/2 bg-cover" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1606660265514-358ebbadc80d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1575&q=80)' }}></div>
      ...
      <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <a href="#" className="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">O inicia sesión con correo</a>
          <span className="w-1/5 border-b dark:border-gray-600 lg:w-1/4"></span>
        </div>

        <div className="mt-4">
          <label className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" htmlFor="LoggingEmailAddress">Correo electrónico</label>
        ...
        <div className="mt-4">
          <div className="flex justify-between">
            ...
            <a href="#" className="text-xs text-gray-500 dark:text-gray-300 hover:underline">¿Olvidaste la contraseña?</a>
          </div>
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <a href="#" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">O regístrate</a>
          <span className="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
        </div>
      </div>
    </div>
